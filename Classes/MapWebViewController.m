...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    if(fragment != nil && [fragment length] > 0)
    {
        ...
        {
            if([[[listOfContents objectAtIndex:i] objectForKey:@"site"] isEqualToString: fragment])
            {
                [wvController setTitle:[[listOfContents objectAtIndex:i] objectForKey:@"name"]];
                break;
            }
        }
        ...
        [self.webView loadData:htmlData MIMEType:@"text/html" textEncodingName:@"UTF-8" baseURL:[NSURL URLWithString: [NSString stringWithFormat:@"file:/%@//",imagePath]]]; 
