...
struct Station: Identifiable, Hashable {
    ...
    static let allStations: [Station] = [
        Station(id: "G03", name: "Addison Rd", colorImageName: "b", lat: 38.886713, lon: -76.893592),
        ...
        Station(id: "K04", name: "Ballston-MU", colorImageName: "o", lat: 38.882071, lon: -77.111845),
        Station(id: "G01", name: "Benning Rd", colorImageName: "b", lat: 38.890488, lon: -76.938291),
        ...
        Station(id: "G02", name: "Capitol Heights", colorImageName: "b", lat: 38.889757, lon: -76.913382),
        ...
        Station(id: "K02", name: "Clarendon", colorImageName: "o", lat: 38.886373, lon: -77.094953),
        ...
        Station(id: "K01", name: "Court House", colorImageName: "o", lat: 38.89063, lon: -77.084803),
        ...
        Station(id: "K05", name: "East Falls Church", colorImageName: "o", lat: 38.885841, lon: -77.157177),
        Station(id: "D06", name: "Eastern Market", colorImageName: "bo", lat: 38.884124, lon: -76.995334),
        ...
        Station(id: "C03", name: "Farragut West", colorImageName: "bo", lat: 38.901311, lon: -77.03981),
        Station(id: "D04", name: "Federal Center SW", colorImageName: "bo", lat: 38.884958, lon: -77.01586),
        Station(id: "D01", name: "Federal Triangle", colorImageName: "bo", lat: 38.893757, lon: -77.028218),
        Station(id: "C04", name: "Foggy Bottom-GWU", colorImageName: "bo", lat: 38.900599, lon: -77.050273),
        ...
        Station(id: "F03,D03", name: "L'Enfant Plaza", colorImageName: "bogy", lat: 38.884775, lon: -77.021964),
        Station(id: "D12", name: "Landover", colorImageName: "o", lat: 38.934411, lon: -76.890988),
        Station(id: "G05", name: "Downtown Largo", colorImageName: "b", lat: 38.9008, lon: -76.8449),
        ...
        Station(id: "C02", name: "McPherson Sq", colorImageName: "bo", lat: 38.901316, lon: -77.033652),
        Station(id: "A10", name: "Medical Center", colorImageName: "r", lat: 38.999947, lon: -77.097253),
        Station(id: "C01,A01", name: "Metro Center", colorImageName: "bor", lat: 38.898303, lon: -77.028099),
        Station(id: "D09", name: "Minnesota Av", colorImageName: "o", lat: 38.898284, lon: -76.948042),
        Station(id: "G04", name: "Morgan Blvd", colorImageName: "b", lat: 38.8913, lon: -76.8682),
        ...
        Station(id: "D07", name: "Potomac Av", colorImageName: "bo", lat: 38.880841, lon: -76.985721),
        ...
        Station(id: "C05", name: "Rosslyn", colorImageName: "bo", lat: 38.896595, lon: -77.07146),
        ...
        Station(id: "D02", name: "Smithsonian", colorImageName: "bo", lat: 38.888022, lon: -77.028232),
        ...
        Station(id: "D08", name: "Stadium-Armory", colorImageName: "bo", lat: 38.88594, lon: -76.977485),
        ...
        Station(id: "K03", name: "Virginia Sq-GMU", colorImageName: "o", lat: 38.88331, lon: -77.104267),
